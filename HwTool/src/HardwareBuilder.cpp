...
namespace HwTool {
    ...
    Module HardwareBuilder::X20BM11(const std::string &name, const std::string &version,
        ...
        return Module(name, cardType::X20BM11, version,
                {Connection(ConnectorType::X2X1, ConnectorType::X2X2, targetModule,
                        resolvedTargetName)});
    }
    ...
    Module HardwareBuilder::IOCARD2(const std::string &name, cardType type,
            const std::string &targetTB12, const std::string &targetBM11,
    ...
    ModulePack HardwareBuilder::IOCARD(const std::string &name, cardType type,
            const std::string &targetName, const std::string &version) {
